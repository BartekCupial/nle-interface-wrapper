...
setup(
    # Information
    name="nle-interface-wrapper",
    description="NLE interface for LLM agents",
    long_description=long_description,
    long_description_content_type="text/markdown",
    version="2.1.2",
    url="https://github.com/BartekCupial/nle-interface-wrapper",
    ...
    package_data={"nle_interface_wrapper": ["envs/minihack/dat/**"]},
